...
instance.AddOrderSell(idItem,900,12,{from:accounts[1]}).then(ret=>result=ret)
instance.AddOrderBuy(idItem,900,8,{from:accounts[2]}).then(ret=>result=ret)
instance.AddOrderBuy(idItem,900,8,{from:accounts[2]}).then(ret=>result=ret)
...
instance.TryAgreeOrders(idItem,900,SELL,0,8).then(ret=>result=ret)
instance.TryAgreeOrders(idItem,900,BUY,1,6).then(ret=>result=ret)
result.logs
